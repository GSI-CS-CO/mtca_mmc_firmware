...
#define PLL_INIT
		...
		.set   	SET_PLLCFG_MUL2,	0x1		// M = 2
		.set	SET_PLLCFG_MUL3,	0x2   	// M = 3
		.set	SET_PLLCFG_MUL4,	0x3		// M = 4
		.set	SET_PLLCFG_MUL5,	0x4		// M = 5
		.set	SET_PLLCFG_MUL6,	0x5		// M = 6
		
		.set	SET_PLLCFG_DIV1,	(0x0<<4)	//	P = 1
		.set	SET_PLLCFG_DIV2,	(0x1<<4)	// 	P = 2
		.set	SET_PLLCFG_DIV4,	(0x2<<4)	// 	P = 4
		.set	SET_PLLCFG_DIV8,	(0x3<<4)	//	P = 8
		
		.set	PLLCFG_INIT_VAL,	SET_PLLCFG_MUL2 | SET_PLLCFG_DIV1
		.set	SET_PLLCON_ENABLE,	1
		.set	SET_PLLCON_CONNECT,	2

/*

	AMC_FTRN_BOARD: 24 Mhz
		M = 2, P = 1
		CCLK = M x 24 MHz = 48 MHz
		FCCO = CCLK x 2 x P = 96
		FCCO = 24 x M x 2 x P = 96
*/
 ...
 */
		...
		.set	VPBDIV_INIT_VAL,	0x2 // APB bus clock is half of the processor clock
